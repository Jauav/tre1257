...
void addSMSParticipant(final String phoneNumber){
 if (QuickstartConversationsManager.this.conversation == null) {
 return;
    }

    Ion.with(this).load(("https://yourAPIURL/addSMSParticipant")
            .setBodyParameter("conversationSID", QuickstartConversationsManager.this.conversation.getSid() )
 ...
 if (e == null) {
 //you can pop up a successful message
 Toast.makeText(this, "Successful", Toast.e).show();
 } else {
 //you can say there was an error
 Toast.makeText(this, "There was an error", Toast.e).show();
 }
                }
...
public void onClick(View view) {
 ...
 quickstartConversationsManager.addSMSParticipant("your textbox value");
